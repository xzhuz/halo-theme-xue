            ...
            <#list item.links?sort_by('priority')?reverse  as link>
              <a class="m-card flex p-1.5 text-gray-800 dark:text-gray-300 bg-white dark:bg-gray-800 rounded shadow-md justify-start content-start flex-col w-full max-w-16" target="_blank"
                ...
                <div class="flex self-center">
                  <img class="lazyload object-cover m-avatar w-20 h-20 rounded-full bg-white max-w-full border-2 border-white border-solid no-zoom" data-src="${link.logo}" src="${theme_base!}/source/images/loading.gif" onerror="onerror=null;src='${theme_base!}/source/images/loading.gif'">
                </div>
