        ...
        <div style="position: relative">
          <#list journals.content as journal>
            <div class="min-h-screen py-6 flex flex-col justify-center items-center">
              <div class="w-full bg-white border border-gray-300 rounded-2xl py-3 px-5">
                <div class="flex">
                  <div class="mr-2">
                    <img class="rounded-full h-10 w-10" src="${user.avatar!}" alt="${user.nickname!}"/>
                  </div>
                  <div>
                ...
                <div class="py-3">
                  <p class="text-lg"> ${journal.content!}</p>
                  <div class="flex">
